...
CREATE TABLE IF NOT EXISTS zones (
  ...
  max_weight NUMERIC(18, 2) NOT NULL DEFAULT 0,
  max_volume NUMERIC(18, 2) NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS racks (
  ...
  name VARCHAR(100),
  max_weight NUMERIC(18, 2) NOT NULL DEFAULT 10000,
  max_volume NUMERIC(18, 2) NOT NULL DEFAULT 80,
  status VARCHAR(20) NOT NULL DEFAULT 'Active',
  active BOOLEAN NOT NULL DEFAULT TRUE,
  created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS levels (
  ...
  max_weight NUMERIC(18, 2) NOT NULL DEFAULT 2500,
  max_volume NUMERIC(18, 2) NOT NULL DEFAULT 20,
  status VARCHAR(20) NOT NULL DEFAULT 'Active',
  active BOOLEAN NOT NULL DEFAULT TRUE,
  created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS bins (
  ...
  max_weight NUMERIC(18, 2) NOT NULL DEFAULT 500,
  max_volume NUMERIC(18, 2) NOT NULL DEFAULT 4,
  current_weight NUMERIC(18, 2) NOT NULL DEFAULT 0,
  current_volume NUMERIC(18, 2) NOT NULL DEFAULT 0,
...
ALTER TABLE zones
  ...
  ADD COLUMN IF NOT EXISTS max_weight NUMERIC(18, 2) NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS max_volume NUMERIC(18, 2) NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS status VARCHAR(20) NOT NULL DEFAULT 'Active',
