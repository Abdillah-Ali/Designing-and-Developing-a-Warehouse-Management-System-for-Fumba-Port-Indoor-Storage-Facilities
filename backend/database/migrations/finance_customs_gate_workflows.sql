...
SELECT
  CASE WHEN t.cargo_type = 'General Goods' THEN 'TRV-BASE-GENERAL-001' ELSE 'TRV-BASE-DEFAULT-001' END,
  t.id,
  1,
  t.cargo_type,
  t.charging_unit,
  CASE WHEN t.cargo_type = 'General Goods' THEN 10000 ELSE 8000 END,
  'TZS',
  1,
  0,
  'none',
