...
router.get("/policies", requirePermission("system.notifications.configure"), getNotificationPolicies);
router.put("/policies/:eventKey", requirePermission("system.notifications.configure"), updateNotificationPolicyRoute);
